 ...
 * Define Constants 
 ****************************************/ 
#define WIFISSID "Redmi K40 Gaming" //WIFI SSID aqui 
#define PASSWORD "Kiya12345" // WIFI pwd 
#define TOKEN "BBUS-1rz4hgHLmh2mbfJpeBHLesmzIFi4RH" // Ubidots TOKEN name el mismo que usamos en clase 
#define MQTT_CLIENT_NAME "67218112a553040c739d6ba5" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices 
