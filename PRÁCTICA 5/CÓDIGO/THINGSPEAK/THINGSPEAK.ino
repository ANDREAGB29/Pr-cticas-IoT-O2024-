...
// wifi credentials
const char *ssid = "INFINITUMAB06"; //CAMBIAR puede ser infinitum
const char *password = "QB7LCdXcGL"; //CAMBIAR contra infinitum
WiFiClient  client;

// OpenWeather
String apiTemperature;
String serverPath = "https://api.openweathermap.org/data/2.5/weather?lat=40.8095&lon=-129.5243&appid=29aeeda9a0c24fdc67038c942c733df1&units=metric"; 

// ThingSpeak
uint32_t channelNumber =  2720929; 
const char *writeAPIKey = "71TIARDKP2JPFLYL"; //REVISAR
...
void sendDataToThingSpeak(){
    ...
    int code = ThingSpeak.writeFields(2720929,"71TIARDKP2JPFLYL");
    if(code == 200)
